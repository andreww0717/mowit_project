...
urlpatterns = [
    ...
    path('home/contractor/serviceregistration/', views.service_register_request, name='serviceregistration'),
    path('contractor/serviceregistration/', views.service_register_request, name='serviceregistration'),
